...
public class EmeraldArmorItem extends ArmorItem {
	...
	private static final Map<ArmorMaterial, StatusEffectInstance> MATERIAL_TO_EFFECT_MAP = new ImmutableMap.Builder<ArmorMaterial, StatusEffectInstance>().put(Emerald, new StatusEffectInstance(StatusEffects.HERO_OF_THE_VILLAGE, 400, 1)).build();

	public EmeraldArmorItem(ArmorMaterial material, ArmorSlot slot, Settings settings) {
